    ...
    return (
        <div>
            ...
            <div className="md:my-20 my-8">
                <Cover heading="Salad" subHeading="Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." image="https://i.ibb.co/gS2CV0V/flat-lay-salad-with-chicken-sesame-seeds-23-2148700369.jpg"></Cover>
            </div>
