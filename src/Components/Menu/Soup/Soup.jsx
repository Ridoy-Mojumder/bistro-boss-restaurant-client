        ...
        <div>
            <div>
                ...
                <div className="md:my-20 my-8">
                    <Cover heading="Soup" subHeading="Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." image="https://i.ibb.co/Lx3VsWP/italian-meatball-soup-stelline-pasta-bowl-black-table-2829-4646.jpg"></Cover>
                </div>
